...
weasel.repl.process_message = (function (){var method_table__21185__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"weasel.repl","process-message"),new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__21189__auto__,method_table__21185__auto__,prefer_table__21186__auto__,method_cache__21187__auto__,cached_hierarchy__21188__auto__));
})();
...
while (G__35243__i < G__35243__a.length) {G__35243__a[G__35243__i] = arguments[G__35243__i + 0]; ++G__35243__i;}
  args = new cljs.core.IndexedSeq(G__35243__a,0);
} 
return weasel$repl$repl_print__delegate.call(this,args);};
weasel$repl$repl_print.cljs$lang$maxFixedArity = 0;
weasel$repl$repl_print.cljs$lang$applyTo = (function (arglist__35244){
var args = cljs.core.seq(arglist__35244);
...
while (G__35245__i < G__35245__a.length) {G__35245__a[G__35245__i] = arguments[G__35245__i + 0]; ++G__35245__i;}
  args = new cljs.core.IndexedSeq(G__35245__a,0);
} 
return weasel$repl$console_print__delegate.call(this,args);};
weasel$repl$console_print.cljs$lang$maxFixedArity = 0;
weasel$repl$console_print.cljs$lang$applyTo = (function (arglist__35246){
var args = cljs.core.seq(arglist__35246);
...
var G__35247__delegate = function (args){
...
while (G__35248__i < G__35248__a.length) {G__35248__a[G__35248__i] = arguments[G__35248__i + 0]; ++G__35248__i;}
  args = new cljs.core.IndexedSeq(G__35248__a,0);
} 
return G__35247__delegate.call(this,args);};
G__35247.cljs$lang$maxFixedArity = 0;
G__35247.cljs$lang$applyTo = (function (arglist__35249){
var args = cljs.core.seq(arglist__35249);
return G__35247__delegate(args);
});
...
var weasel$repl$connect__delegate = function (repl_server_url,p__35250){
var map__35253 = p__35250;
...
var print = cljs.core.get.call(null,map__35253__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__35253__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__35253__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__35253__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__35253__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__35254 = cljs.reader.read_string.call(null,evt.message);
...
var message = map__35254__$1;
var op = cljs.core.get.call(null,map__35254__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.filter.call(null,((function (gntp,repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose){
return (function (name){
return (goog.dependencies_.visited[(gntp[name])]);
});})(gntp,repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose))
,cljs.core.js_keys.call(null,gntp)));
})();

goog.isProvided_ = ((function (repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose){
return (function (_){
return false;
});})(repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose))
;

goog.require = ((function (repl_connection,map__35253,map__35253__$1,print,on_close,on_error,on_open,verbose){
...
var G__35255__i = 0, G__35255__a = new Array(arguments.length -  1);
while (G__35255__i < G__35255__a.length) {G__35255__a[G__35255__i] = arguments[G__35255__i + 1]; ++G__35255__i;}
  p__35250 = new cljs.core.IndexedSeq(G__35255__a,0);
} 
return weasel$repl$connect__delegate.call(this,repl_server_url,p__35250);};
weasel$repl$connect.cljs$lang$maxFixedArity = 1;
weasel$repl$connect.cljs$lang$applyTo = (function (arglist__35256){
var repl_server_url = cljs.core.first(arglist__35256);
var p__35250 = cljs.core.rest(arglist__35256);
return weasel$repl$connect__delegate(repl_server_url,p__35250);
});
